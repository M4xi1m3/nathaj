...
describe('STP Switch', () => {
    ...
    it('triangle', () => {
        const net = new Network();
        const sw1 = new STPSwitch(net, 'sw1', '00:00:00:00:01:01', 3);
        const sw2 = new STPSwitch(net, 'sw2', '00:00:00:00:02:01', 3);
        const sw3 = new STPSwitch(net, 'sw3', '00:00:00:00:03:01', 3);
